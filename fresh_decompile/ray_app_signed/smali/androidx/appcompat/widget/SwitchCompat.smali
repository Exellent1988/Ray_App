...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->v:Landroid/view/VelocityTracker;

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-static {p0, v3}, Lu/b/h/l0;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->F:Landroid/text/TextPaint;
    ...
    sget-object v8, Lu/b/b;->v:[I

    .line 2
    new-instance v5, Lu/b/h/q0;
    ...
    invoke-direct {v5, p1, v10}, Lu/b/h/q0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    const/4 v12, 0x0

    const v11, 0x7f0302d3
    ...
    .line 3
    invoke-static/range {v6 .. v12}, Lu/i/j/p;->m(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    const/4 v6, 0x2

    invoke-virtual {v5, v6}, Lu/b/h/q0;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v7}, Lu/b/h/q0;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-virtual {v5, v2}, Lu/b/h/q0;->n(I)Ljava/lang/CharSequence;

    move-result-object v7

    iput-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->o:Ljava/lang/CharSequence;

    invoke-virtual {v5, v4}, Lu/b/h/q0;->n(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v7, v4}, Lu/b/h/q0;->a(IZ)Z
    ...
    invoke-virtual {v5, v8, v2}, Lu/b/h/q0;->f(II)I
    ...
    invoke-virtual {v5, v8, v2}, Lu/b/h/q0;->a(IZ)Z
    ...
    invoke-virtual {v5, v8}, Lu/b/h/q0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v5, v8, v9}, Lu/b/h/q0;->j(II)I

    move-result v8

    invoke-static {v8, v1}, Lu/b/h/y;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v5, v8, v2}, Lu/b/h/q0;->l(II)I
    ...
    .line 7
    sget-object v11, Lu/b/d/a/a;->a:Ljava/lang/ThreadLocal;
    ...
    :goto_1
    iput-object v10, p0, Landroidx/appcompat/widget/SwitchCompat;->G:Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v1, v2}, Lu/b/f/a;-><init>(Landroid/content/Context;)V

    :cond_15
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->J:Landroid/text/method/TransformationMethod;
    ...
    .line 18
    :cond_16
    new-instance v1, Lu/b/h/s;

    invoke-direct {v1, p0}, Lu/b/h/s;-><init>(Landroid/widget/TextView;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->L:Lu/b/h/s;

    invoke-virtual {v1, p2, v0}, Lu/b/h/s;->e(Landroid/util/AttributeSet;I)V

    .line 19
    iget-object p2, v5, Lu/b/h/q0;->b:Landroid/content/res/TypedArray;
...
.method private getThumbOffset()I
    ...
    invoke-static {p0}, Lu/b/h/w0;->b(Landroid/view/View;)Z
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lu/b/h/y;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lu/b/h/y;->c:Landroid/graphics/Rect;
...
.method public final d()V
    ...
    invoke-direct {v2, v4, v3, v5, v1}, Lu/i/j/s;-><init>(ILjava/lang/Class;II)V

    .line 3
    invoke-virtual {v2, p0, v0}, Lu/i/j/p$b;->e(Landroid/view/View;Ljava/lang/Object;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Lu/b/h/y;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Lu/b/h/y;->c:Landroid/graphics/Rect;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lu/b/h/y;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lu/b/h/y;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
