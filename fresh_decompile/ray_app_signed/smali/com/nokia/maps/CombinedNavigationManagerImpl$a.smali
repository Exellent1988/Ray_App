.class public Lcom/nokia/maps/CombinedNavigationManagerImpl$a;
...
.method public constructor <init>(Lcom/nokia/maps/CombinedNavigationManagerImpl;Lcom/here/android/mpa/venues3d/LinkingRoute;Lcom/here/android/mpa/venues3d/CombinedRoute;)V
    ...
    iput-object p1, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->c:Lcom/nokia/maps/CombinedNavigationManagerImpl;

    iput-object p2, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->a:Lcom/here/android/mpa/venues3d/LinkingRoute;

    iput-object p3, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->b:Lcom/here/android/mpa/venues3d/CombinedRoute;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->c:Lcom/nokia/maps/CombinedNavigationManagerImpl;
    ...
    iget-object v2, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->a:Lcom/here/android/mpa/venues3d/LinkingRoute;

    iget-object v3, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->c:Lcom/nokia/maps/CombinedNavigationManagerImpl;

    invoke-static {v3}, Lcom/nokia/maps/CombinedNavigationManagerImpl;->d(Lcom/nokia/maps/CombinedNavigationManagerImpl;)D

    move-result-wide v3

    iget-object v5, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->c:Lcom/nokia/maps/CombinedNavigationManagerImpl;

    invoke-static {v5}, Lcom/nokia/maps/CombinedNavigationManagerImpl;->e(Lcom/nokia/maps/CombinedNavigationManagerImpl;)Z

    move-result v5

    invoke-direct {v1, v2, v3, v4, v5}, Lcom/here/android/mpa/venues3d/VenueSimulatedLocationSource;-><init>(Lcom/here/android/mpa/venues3d/LinkingRoute;DZ)V
    ...
    iget-object v1, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->c:Lcom/nokia/maps/CombinedNavigationManagerImpl;
    ...
    iget-object v1, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->a:Lcom/here/android/mpa/venues3d/LinkingRoute;

    iget-object v2, p0, Lcom/nokia/maps/CombinedNavigationManagerImpl$a;->b:Lcom/here/android/mpa/venues3d/CombinedRoute;

    invoke-virtual {v0, v1, v2}, Lcom/here/android/mpa/venues3d/VenueNavigationManager;->start(Lcom/here/android/mpa/venues3d/LinkingRoute;Lcom/here/android/mpa/venues3d/CombinedRoute;)Z
