...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    const-string v3, "AUTOMATIC"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;->AUTOMATIC:Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    new-instance v3, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    const-string v5, "COMMUNITY"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;->COMMUNITY:Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    new-instance v5, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    const-string v7, "PRIVATE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;->PRIVATE:Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    new-instance v7, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    const-string v9, "DRAFT"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;->DRAFT:Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;
    ...
    sput-object v9, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;->a:[Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;
...
.method public static valueOf(Ljava/lang/String;)Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;
    ...
    check-cast p0, Lcom/here/android/mpa/common/LocationDataSourceHERE$IndoorPositioningMode;
