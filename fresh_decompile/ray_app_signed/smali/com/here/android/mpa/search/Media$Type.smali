...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/here/android/mpa/search/Media$Type;

    const-string v3, "EDITORIAL"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/here/android/mpa/search/Media$Type;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/here/android/mpa/search/Media$Type;->EDITORIAL:Lcom/here/android/mpa/search/Media$Type;

    new-instance v3, Lcom/here/android/mpa/search/Media$Type;

    const-string v5, "IMAGE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/here/android/mpa/search/Media$Type;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/here/android/mpa/search/Media$Type;->IMAGE:Lcom/here/android/mpa/search/Media$Type;

    new-instance v5, Lcom/here/android/mpa/search/Media$Type;

    const-string v7, "RATING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/here/android/mpa/search/Media$Type;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/here/android/mpa/search/Media$Type;->RATING:Lcom/here/android/mpa/search/Media$Type;

    new-instance v7, Lcom/here/android/mpa/search/Media$Type;

    const-string v9, "REVIEW"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/here/android/mpa/search/Media$Type;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/here/android/mpa/search/Media$Type;->REVIEW:Lcom/here/android/mpa/search/Media$Type;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/here/android/mpa/search/Media$Type;
    ...
    sput-object v9, Lcom/here/android/mpa/search/Media$Type;->a:[Lcom/here/android/mpa/search/Media$Type;
...
.method public static valueOf(Ljava/lang/String;)Lcom/here/android/mpa/search/Media$Type;
    ...
    check-cast p0, Lcom/here/android/mpa/search/Media$Type;
