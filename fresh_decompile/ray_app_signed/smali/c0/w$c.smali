...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILc0/h;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lc0/w$c;->a:Ljava/lang/reflect/Method;

    iput p2, p0, Lc0/w$c;->b:I

    iput-boolean p4, p0, Lc0/w$c;->c:Z
...
.method public a(Lc0/y;Ljava/lang/Object;)V
    ...
    .line 3
    iget-boolean v1, p0, Lc0/w$c;->c:Z

    invoke-virtual {p1, v2, v4, v1}, Lc0/y;->a(Ljava/lang/String;Ljava/lang/String;Z)V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lc0/w$c;->a:Ljava/lang/reflect/Method;

    iget p2, p0, Lc0/w$c;->b:I
