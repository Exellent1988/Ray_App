...
.field public v:Landroidx/appcompat/widget/ActionMenuPresenter$c;

.field public w:Landroidx/appcompat/widget/ActionMenuPresenter$b;

.field public final x:Landroidx/appcompat/widget/ActionMenuPresenter$f;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lu/b/g/i/b;-><init>(Landroid/content/Context;II)V
...
.method public a(Lu/b/g/i/g;Z)V
    ...
    .line 1
    iget-object v0, p0, Lu/b/g/i/b;->e:Lu/b/g/i/m$a;
...
.method public c(Landroid/content/Context;Lu/b/g/i/g;)V
    .locals 4

    .line 1
    iput-object p1, p0, Lu/b/g/i/b;->b:Landroid/content/Context;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    iput-object p2, p0, Lu/b/g/i/b;->c:Lu/b/g/i/g;
    ...
    iget-object v2, p0, Lu/b/g/i/b;->a:Landroid/content/Context;
...
.method public d(Lu/b/g/i/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3

    invoke-virtual {p1}, Lu/b/g/i/i;->getActionView()Landroid/view/View;
    ...
    .line 1
    :cond_0
    instance-of v0, p2, Lu/b/g/i/n$a;

    if-eqz v0, :cond_1

    check-cast p2, Lu/b/g/i/n$a;

    goto :goto_0

    .line 2
    :cond_1
    iget-object p2, p0, Lu/b/g/i/b;->d:Landroid/view/LayoutInflater;

    iget v0, p0, Lu/b/g/i/b;->g:I
    ...
    .line 3
    :goto_0
    invoke-interface {p2, p1, v1}, Lu/b/g/i/n$a;->d(Lu/b/g/i/i;I)V

    iget-object v0, p0, Lu/b/g/i/b;->h:Lu/b/g/i/n;
    ...
    invoke-virtual {v2, v0}, Landroidx/appcompat/view/menu/ActionMenuItemView;->setItemInvoker(Lu/b/g/i/g$b;)V
    ...
    .line 5
    :cond_3
    iget-boolean p1, p1, Lu/b/g/i/i;->C:Z
...
.method public e(Lu/b/g/i/r;)Z
    ...
    .line 1
    :goto_0
    iget-object v2, v0, Lu/b/g/i/r;->z:Lu/b/g/i/g;

    .line 2
    iget-object v3, p0, Lu/b/g/i/b;->c:Lu/b/g/i/g;

    if-eq v2, v3, :cond_1

    move-object v0, v2

    check-cast v0, Lu/b/g/i/r;

    goto :goto_0

    .line 3
    :cond_1
    iget-object v0, v0, Lu/b/g/i/r;->A:Lu/b/g/i/i;

    .line 4
    iget-object v2, p0, Lu/b/g/i/b;->h:Lu/b/g/i/n;
    ...
    instance-of v7, v6, Lu/b/g/i/n$a;

    if-eqz v7, :cond_3

    move-object v7, v6

    check-cast v7, Lu/b/g/i/n$a;

    invoke-interface {v7}, Lu/b/g/i/n$a;->getItemData()Lu/b/g/i/i;
    ...
    .line 5
    :cond_5
    iget-object v0, p1, Lu/b/g/i/r;->A:Lu/b/g/i/i;

    .line 6
    iget v0, v0, Lu/b/g/i/i;->a:I

    .line 7
    invoke-virtual {p1}, Lu/b/g/i/g;->size()I
    ...
    invoke-virtual {p1, v2}, Lu/b/g/i/g;->getItem(I)Landroid/view/MenuItem;
    ...
    iget-object v2, p0, Lu/b/g/i/b;->b:Landroid/content/Context;

    invoke-direct {v0, p0, v2, p1, v3}, Landroidx/appcompat/widget/ActionMenuPresenter$a;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lu/b/g/i/r;Landroid/view/View;)V

    iput-object v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->u:Landroidx/appcompat/widget/ActionMenuPresenter$a;

    .line 8
    iput-boolean v1, v0, Lu/b/g/i/l;->h:Z

    iget-object v0, v0, Lu/b/g/i/l;->j:Lu/b/g/i/k;

    if-eqz v0, :cond_8

    invoke-virtual {v0, v1}, Lu/b/g/i/k;->p(Z)V
    ...
    .line 10
    invoke-virtual {v0}, Lu/b/g/i/l;->f()Z
...
.method public f(Z)V
    ...
    .line 1
    iget-object p1, p0, Lu/b/g/i/b;->h:Lu/b/g/i/n;
    ...
    invoke-virtual {v3}, Lu/b/g/i/g;->i()V

    iget-object v3, p0, Lu/b/g/i/b;->c:Lu/b/g/i/g;

    invoke-virtual {v3}, Lu/b/g/i/g;->l()Ljava/util/ArrayList;
    ...
    .line 2
    invoke-virtual {v7}, Lu/b/g/i/i;->g()Z
    ...
    instance-of v9, v8, Lu/b/g/i/n$a;

    if-eqz v9, :cond_1

    move-object v9, v8

    check-cast v9, Lu/b/g/i/n$a;

    invoke-interface {v9}, Lu/b/g/i/n$a;->getItemData()Lu/b/g/i/i;
    ...
    :goto_1
    invoke-virtual {p0, v7, v8, p1}, Landroidx/appcompat/widget/ActionMenuPresenter;->d(Lu/b/g/i/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_3
    iget-object v7, p0, Lu/b/g/i/b;->h:Lu/b/g/i/n;
    ...
    iget-object p1, p0, Lu/b/g/i/b;->c:Lu/b/g/i/g;

    if-eqz p1, :cond_a

    .line 9
    invoke-virtual {p1}, Lu/b/g/i/g;->i()V

    iget-object p1, p1, Lu/b/g/i/g;->i:Ljava/util/ArrayList;
    ...
    check-cast v5, Lu/b/g/i/i;

    .line 11
    iget-object v5, v5, Lu/b/g/i/i;->A:Lu/i/j/b;
    ...
    iget-object v0, p1, Lu/b/g/i/g;->j:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lu/b/g/i/b;->a:Landroid/content/Context;
...
.method public g()Z
    ...
    invoke-interface {v0}, Lu/b/g/i/p;->dismiss()V
...
.method public h()Z
    ...
    invoke-virtual {v1}, Lu/b/g/i/g;->l()Ljava/util/ArrayList;
    ...
    iget-object v8, v0, Lu/b/g/i/b;->h:Lu/b/g/i/n;
    ...
    check-cast v15, Lu/b/g/i/i;

    .line 1
    iget v3, v15, Lu/b/g/i/i;->y:I
    ...
    .line 3
    iget-boolean v2, v15, Lu/b/g/i/i;->C:Z
    ...
    check-cast v10, Lu/b/g/i/i;

    .line 5
    iget v11, v10, Lu/b/g/i/i;->y:I
    ...
    .line 6
    invoke-virtual {v0, v10, v12, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->d(Lu/b/g/i/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_b
    invoke-virtual {v10, v14}, Lu/b/g/i/i;->k(Z)V
    ...
    invoke-virtual {v0, v10, v13, v8}, Landroidx/appcompat/widget/ActionMenuPresenter;->d(Lu/b/g/i/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast v14, Lu/b/g/i/i;

    .line 11
    iget v13, v14, Lu/b/g/i/i;->b:I

    if-ne v13, v11, :cond_15

    .line 12
    invoke-virtual {v14}, Lu/b/g/i/i;->g()Z
    ...
    invoke-virtual {v14, v13}, Lu/b/g/i/i;->k(Z)V
    ...
    :cond_17
    invoke-virtual {v10, v15}, Lu/b/g/i/i;->k(Z)V
    ...
    invoke-virtual {v10, v11}, Lu/b/g/i/i;->k(Z)V
...
.method public n()Z
    ...
    iget-object v0, p0, Lu/b/g/i/b;->c:Lu/b/g/i/g;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lu/b/g/i/b;->h:Lu/b/g/i/n;
    ...
    .line 1
    invoke-virtual {v0}, Lu/b/g/i/g;->i()V

    iget-object v0, v0, Lu/b/g/i/g;->j:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lu/b/g/i/b;->b:Landroid/content/Context;

    iget-object v4, p0, Lu/b/g/i/b;->c:Lu/b/g/i/g;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/ActionMenuPresenter$e;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;Lu/b/g/i/g;Landroid/view/View;Z)V
