...
# instance fields
.field public a:Lu/b/g/i/g;

.field public b:Lu/b/g/i/i;
...
.method public c(Landroid/content/Context;Lu/b/g/i/g;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->a:Lu/b/g/i/g;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lu/b/g/i/i;

    if-eqz v0, :cond_0

    invoke-virtual {p1, v0}, Lu/b/g/i/g;->d(Lu/b/g/i/i;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->a:Lu/b/g/i/g;
...
.method public f(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lu/b/g/i/i;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->a:Lu/b/g/i/g;

    invoke-virtual {v2, v1}, Lu/b/g/i/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lu/b/g/i/i;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->i(Lu/b/g/i/g;Lu/b/g/i/i;)Z
...
.method public i(Lu/b/g/i/g;Lu/b/g/i/i;)Z
    ...
    instance-of v0, p1, Lu/b/g/b;

    if-eqz v0, :cond_0

    check-cast p1, Lu/b/g/b;

    invoke-interface {p1}, Lu/b/g/b;->e()V
    ...
    .line 2
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lu/b/g/i/i;
    ...
    .line 3
    iput-boolean p1, p2, Lu/b/g/i/i;->C:Z

    iget-object p2, p2, Lu/b/g/i/i;->n:Lu/b/g/i/g;

    invoke-virtual {p2, p1}, Lu/b/g/i/g;->q(Z)V
...
.method public j(Lu/b/g/i/g;Lu/b/g/i/i;)Z
    ...
    invoke-virtual {p2}, Lu/b/g/i/i;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->i:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lu/b/g/i/i;
    ...
    invoke-virtual {p2, v0}, Lu/b/g/i/g;->q(Z)V
    ...
    instance-of v0, p2, Lu/b/g/b;

    if-eqz v0, :cond_6

    check-cast p2, Lu/b/g/b;

    invoke-interface {p2}, Lu/b/g/b;->c()V
