...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    const-string v3, "REDIRECTED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;->REDIRECTED:Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    new-instance v3, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    const-string v5, "REPLACED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;->REPLACED:Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    new-instance v5, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    const-string v7, "CANCELLED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;->CANCELLED:Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    new-instance v7, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    const-string v9, "ADDITIONAL"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;->ADDITIONAL:Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;
    ...
    sput-object v9, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;->a:[Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;
...
.method public static valueOf(Ljava/lang/String;)Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;
    ...
    check-cast p0, Lcom/here/android/mpa/urbanmobility/RealTimeInfo$RealTimeStatus;
