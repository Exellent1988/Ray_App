...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;

    const-string v3, "SIMULATION"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;->SIMULATION:Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;

    new-instance v3, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;

    const-string v5, "NAVIGATION"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;->NAVIGATION:Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;

    new-instance v5, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;

    const-string v7, "TRACKING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;->TRACKING:Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;
    ...
    sput-object v7, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;->a:[Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;
...
.method public static valueOf(Ljava/lang/String;)Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;
    ...
    check-cast p0, Lcom/here/android/mpa/guidance/NavigationManager$NavigationMode;
