...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/here/android/mpa/ar/ARController$SensorType;

    const-string v3, "COMPASS"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/here/android/mpa/ar/ARController$SensorType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/here/android/mpa/ar/ARController$SensorType;->COMPASS:Lcom/here/android/mpa/ar/ARController$SensorType;

    new-instance v3, Lcom/here/android/mpa/ar/ARController$SensorType;

    const-string v5, "ACCELEROMETER"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/here/android/mpa/ar/ARController$SensorType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/here/android/mpa/ar/ARController$SensorType;->ACCELEROMETER:Lcom/here/android/mpa/ar/ARController$SensorType;

    new-instance v5, Lcom/here/android/mpa/ar/ARController$SensorType;

    const-string v7, "GYROSCOPE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/here/android/mpa/ar/ARController$SensorType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/here/android/mpa/ar/ARController$SensorType;->GYROSCOPE:Lcom/here/android/mpa/ar/ARController$SensorType;

    new-instance v7, Lcom/here/android/mpa/ar/ARController$SensorType;

    const-string v9, "CAMERA"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/here/android/mpa/ar/ARController$SensorType;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/here/android/mpa/ar/ARController$SensorType;->CAMERA:Lcom/here/android/mpa/ar/ARController$SensorType;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/here/android/mpa/ar/ARController$SensorType;
    ...
    sput-object v9, Lcom/here/android/mpa/ar/ARController$SensorType;->a:[Lcom/here/android/mpa/ar/ARController$SensorType;
...
.method public static valueOf(Ljava/lang/String;)Lcom/here/android/mpa/ar/ARController$SensorType;
    ...
    check-cast p0, Lcom/here/android/mpa/ar/ARController$SensorType;
